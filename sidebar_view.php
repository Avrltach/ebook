        ...
        <ul class="sidebar-menu" data-widget="tree">
			...
			<li class="treeview <?php if($this->uri->uri_string() == 'data/kategori'){ echo 'active';}?>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class=" <?php if($this->uri->uri_string() == 'data/rusak'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/rusak");?>" class="cursor">
                            <span class="fa fa-trash-o"></span> Buku Rusak
            ...
            <li class="treeview 
                <?php if($this->uri->uri_string() == 'data'){ echo 'active';}?>
                <?php if($this->uri->uri_string() == 'data/laporaj'){ echo 'active';}?>
...
">
                ...
                <li class=" <?php if($this->uri->uri_string() == 'data/laporan'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/laporan");?>" class="cursor">
                            <span class="fa fa-bookmark"></span> pinjam 
                            
                        </a>
                    </li>
                    <li class=" <?php if($this->uri->uri_string() == 'data/laporan'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/laporankembali");?>" class="cursor">
                            <span class="fa fa-bookmark-o"></span> kembali 
                            
                        </a>
                    </li>
                    
                    <li class=" <?php if($this->uri->uri_string() == 'data/laporan'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/laporanbuku");?>" class="cursor">
                            <span class="fa fa-book"></span> buku
                            
                        </a>
                    </li>
                    <li class=" <?php if($this->uri->uri_string() == 'data/laporan'){ echo 'active';}?>">
                        <a href="<?php echo base_url("data/laporandatapengguna");?>" class="cursor">
                            <span class="fa fa-user"></span> data penggguna
